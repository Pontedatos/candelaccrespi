...
Dedicó su vida a investigar con la variables dependiente "mortandad en un país" en relación a las condiciones de sanitarias del mismo (sobre todo a nivel de sanidad pública: disposición de los hospitales, posibilidad de cobertura...). Su enorme labor la convirtió en la primera mujer en conseguir un renombre como estadista en Reino Unido y también a escala internacional. 
...
Previamente citábamos, en la pregunta de quién es Philip Meyer, al caso de la *CBS News Election Coverage*. Este caso hace referecia a la primera vez en la historia en la que se hizo uso de los programas estadísticos de una computadora (UNIVAC) con fines informativos. El objetivo de este proyecto (liderado por grandes figuras de autoridad periodística como son Walter Cronkite y Edward Murrow entre otros) era estimar los resultados de las elecciones estadounidenses de 1952. Hubo ciertos problemas ya que los resultados del algoritmo no correspondían a los de las encuestas sociales (pero al final la computadora no mentía). 
...
- Por último las líneas de comandos pueden contar con argumentos, de tal forma que se especifique sobre qué archivos o directorios se va a aplicar la orden. Por ejemplo al ejecutar desde mi terminal`ls periodismo-datos` se listan todos los archivos pertenecientes a mi carpeta. 
...
La versión de la SHELL (intérprete de comandos) que utilizo la he conocido ejecutando el siguiente comando: echo $SHELL
/bin/zsh
